...
const dbData = {
    "monthly": {
        "Май 2026": {
                    "СПб 13-1": {
                        "averageScore": -13,
                        "managers": [ { "name": "10:00-13:00", "score": -32 }, { "name": "13:00-15:00", "score": 15 }, { "name": "15:00-17:00", "score": -70 }, { "name": "17:00-19:00", "score": -4 }, { "name": "19:00-22:00", "score": -13 } ],
                        "c5": [ { "violation": "5 и более нарушений по качеству продукта", "count": 5 }, { "violation": "1 половник вместо 1,5 на 35 см", "count": 2 }, { "violation": "Использование бракованного продукта / не списан брак", "count": 2 } ],
                        "c10": [ { "violation": "Риск отравления: потрогали готовый продукт / продукт без термообработки / добавили ингредиент после печи", "count": 2 }, { "violation": "Руки не помыли / без антисептика / без мыла", "count": 1 }, { "violation": "Нарушения при работе с перчатками", "count": 1 } ]
                    },
                    "СПб 13-2": {
                        "averageScore": -35,
                        "managers": [ { "name": "10:00-13:00", "score": -45 }, { "name": "13:00-15:00", "score": -67 }, { "name": "15:00-17:00", "score": 3 }, { "name": "17:00-19:00", "score": 20 }, { "name": "19:00-22:00", "score": -14 } ],
                        "c5": [ { "violation": "Использование щепотки при работе с ингредиентами", "count": 13 }, { "violation": "5 и более нарушений по качеству продукта", "count": 2 }, { "violation": "Работа в фартуке с непищевым", "count": 2 } ],
                        "c10": [ { "violation": "Руки не помыли / без антисептика / без мыла", "count": 7 }, { "violation": "Пищевое / Непищевое - перекрестное загрязнение", "count": 2 }, { "violation": "Предзаготовка продуктов не по стандарту", "count": 2 } ]
                    },
                    "Коряжма-1": {
                        "averageScore": -78,
                        "managers": [ { "name": "10:00-13:00", "score": 30 }, { "name": "13:00-15:00", "score": 58 }, { "name": "15:00-17:00", "score": -65 }, { "name": "17:00-19:00", "score": -270 }, { "name": "19:00-22:00", "score": -10 } ],
                        "c5": [ { "violation": "Использование щепотки при работе с ингредиентами", "count": 25 }, { "violation": "5 и более нарушений по качеству продукта", "count": 5 }, { "violation": "1 половник вместо 1,5 на 35 см", "count": 2 } ],
                        "c10": [ { "violation": "Безопасность при заготовке салатов и чикен роллов", "count": 13 }, { "violation": "Поливка из пакета", "count": 2 }, { "violation": "Руки не помыли / без антисептика / без мыла", "count": 1 } ]
                    },
                    "Приозерск-1": {
                        "averageScore": -115,
                        "managers": [ { "name": "10:00-13:00", "score": -121 }, { "name": "13:00-15:00", "score": -138 }, { "name": "15:00-17:00", "score": -35 }, { "name": "17:00-19:00", "score": -67 }, { "name": "19:00-22:00", "score": -14 } ],
                        "c5": [ { "violation": "Использование щепотки при работе с ингредиентами", "count": 32 }, { "violation": "5 и более нарушений по качеству продукта", "count": 8 }, { "violation": "Использование бракованного продукта / не списан брак", "count": 1 } ],
                        "c10": [ { "violation": "Безопасность при заготовке салатов и чикен роллов", "count": 8 }, { "violation": "Работа с продуктом без фартука или перчаток (без термообработки)", "count": 3 }, { "violation": "Руки не помыли / без антисептика / без мыла", "count": 2 } ]
                    },
                    "Гусев-1": {
                        "averageScore": -87,
                        "managers": [ { "name": "10:00-13:00", "score": 63 }, { "name": "13:00-15:00", "score": -42 }, { "name": "15:00-17:00", "score": -81 }, { "name": "17:00-19:00", "score": -186 }, { "name": "19:00-22:00", "score": -145 } ],
                        "c5": [ { "violation": "5 и более нарушений по качеству продукта", "count": 3 }, { "violation": "Использование бракованного продукта / не списан брак", "count": 3 }, { "violation": "Ингредиенты подняли с линии в продукт / лексан", "count": 3 } ],
                        "c10": [ { "violation": "Нарушения пожарной безопасности", "count": 5 }, { "violation": "Безопасность при заготовке салатов и чикен роллов", "count": 4 }, { "violation": "Предзаготовка продуктов не по стандарту", "count": 3 } ]
                    },
                    "Гурьевск-1": {
                        "averageScore": -54,
                        "managers": [ { "name": "10:00-13:00", "score": -23 }, { "name": "13:00-15:00", "score": -86 }, { "name": "15:00-17:00", "score": -6 }, { "name": "17:00-19:00", "score": -83 }, { "name": "19:00-22:00", "score": -57 } ],
                        "c5": [ { "violation": "5 и более нарушений по качеству продукта", "count": 6 }, { "violation": "Использование щепотки при работе с ингредиентами", "count": 4 }, { "violation": "Работа в фартуке с непищевым", "count": 3 } ],
                        "c10": [ { "violation": "Руки не помыли / без антисептика / без мыла", "count": 5 }, { "violation": "Безопасность при заготовке салатов и чикен роллов", "count": 4 }, { "violation": "Нарушения пожарной безопасности", "count": 3 } ]
                    }
                },
        "Апрель 2026": {
            "СПб 13-1": {
